...
func TestClient_UnifiedOrder(t *testing.T) {
	number := paymod.GetRandomString(32)
	...
	bm.Set("notify_url", "http://www.paymod.ink")
	...
	h5Info["type"] = "Wap"
	h5Info["wap_url"] = "http://www.paymod.ink"
	...
	// 正式
	//sign := paymod.GetWeChatParamSign("wxdaa2ab9ef87b5497", "1368139502", "GFDS8j98rewnmgl45wHTt980jg543abc", body)
	// 沙箱
	//sign, _ := paymod.GetWeChatSanBoxParamSign("wxdaa2ab9ef87b5497", "1368139502", "GFDS8j98rewnmgl45wHTt980jg543abc", body)
	//body.Set("sign", sign)
...
func TestClient_Transfer(t *testing.T) {
	...
	bm := make(paymod.BodyMap)
	bm.Set("nonce_str", paymod.GetRandomString(32))
	bm.Set("partner_trade_no", paymod.GetRandomString(32))
	bm.Set("openid", "o0Df70H2Q0fY8JXh1aFPIRyOBgu8")
