...
func TestMain(m *testing.M) {
	...
	client.SetCharset("utf-8").
		SetSignType(RSA2)
	// SetReturnUrl("https://www.paymodule.ink").
	// SetNotifyUrl("https://www.paymodule.ink")
...
func TestClient_TradePrecreate(t *testing.T) {
	...
	bm.Set("out_trade_no", paymod.GetRandomString(32))
...
func TestClient_TradeWapPay(t *testing.T) {
	...
	bm.Set("out_trade_no", "GZ201909081743431443")
	bm.Set("quit_url", "https://www.paymod.ink")
...
func TestClient_TradePageRefund(t *testing.T) {
	...
	bm.Set("out_request_no", paymod.GetRandomString(32))
...
func TestClient_FundTransToaccountTransfer(t *testing.T) {
	// 请求参数
	bm := make(paymod.BodyMap)
	bm.Set("out_biz_no", paymod.GetRandomString(32))
...
func TestClient_UserCertifyOpenInit(t *testing.T) {
	...
	merchant["return_url"] = "https://www.paymod.ink"
...
func TestClient_ZhimaCreditScoreGet(t *testing.T) {
	// 请求参数
	body := make(paymod.BodyMap)
	body.Set("transaction_id", paymod.GetRandomString(48))
