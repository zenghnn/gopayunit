...
func (a *Client) TradeFastPayRefundQuery(bm paymod.BodyMap) (aliRsp *TradeFastpayRefundQueryResponse, err error) {
	if bm.Get("out_trade_no") == paymod.NULL && bm.Get("trade_no") == paymod.NULL {
...
func (a *Client) TradeOrderSettle(bm paymod.BodyMap) (aliRsp *TradeOrderSettleResponse, err error) {
...
func (a *Client) TradeCreate(bm paymod.BodyMap) (aliRsp *TradeCreateResponse, err error) {
...
func (a *Client) TradeClose(bm paymod.BodyMap) (aliRsp *TradeCloseResponse, err error) {
	if bm.Get("out_trade_no") == paymod.NULL && bm.Get("trade_no") == paymod.NULL {
		return nil, errors.New("out_trade_no and trade_no are not allowed to be null at the same time")
	}
	var bs []byte
...
func (a *Client) TradeCancel(bm paymod.BodyMap) (aliRsp *TradeCancelResponse, err error) {
	if bm.Get("out_trade_no") == paymod.NULL && bm.Get("trade_no") == paymod.NULL {
		return nil, errors.New("out_trade_no and trade_no are not allowed to be null at the same time")
	}
	var bs []byte
...
func (a *Client) TradeRefund(bm paymod.BodyMap) (aliRsp *TradeRefundResponse, err error) {
	if bm.Get("out_trade_no") == paymod.NULL && bm.Get("trade_no") == paymod.NULL {
		return nil, errors.New("out_trade_no and trade_no are not allowed to be null at the same time")
	}
...
func (a *Client) TradePageRefund(bm paymod.BodyMap) (aliRsp *TradePageRefundResponse, err error) {
	if bm.Get("out_trade_no") == paymod.NULL && bm.Get("trade_no") == paymod.NULL {
		return nil, errors.New("out_trade_no and trade_no are not allowed to be null at the same time")
	}
...
func (a *Client) TradePrecreate(bm paymod.BodyMap) (aliRsp *TradePrecreateResponse, err error) {
	err = bm.CheckEmptyError("out_trade_no", "total_amount", "subject")
	if err != nil {
		return nil, err
	}
...
func (a *Client) TradePay(bm paymod.BodyMap) (aliRsp *TradePayResponse, err error) {
...
func (a *Client) TradeQuery(bm paymod.BodyMap) (aliRsp *TradeQueryResponse, err error) {
	if bm.Get("out_trade_no") == paymod.NULL && bm.Get("trade_no") == paymod.NULL {
		return nil, errors.New("out_trade_no and trade_no are not allowed to be null at the same time")
	}
	var bs []byte
...
func (a *Client) TradeAppPay(bm paymod.BodyMap) (payParam string, err error) {
	err = bm.CheckEmptyError("out_trade_no", "total_amount", "subject")
	if err != nil {
...
func (a *Client) TradeWapPay(bm paymod.BodyMap) (payUrl string, err error) {
...
func (a *Client) TradePagePay(bm paymod.BodyMap) (payUrl string, err error) {
...
func (a *Client) FundTransToaccountTransfer(bm paymod.BodyMap) (aliRsp *FundTransToaccountTransferResponse, err error) {
	if bm.Get("out_biz_no") == paymod.NULL {
...
func (a *Client) FundTransUniTransfer(bm paymod.BodyMap) (aliRsp *FundTransUniTransferResponse, err error) {
...
func (a *Client) FundTransCommonQuery(bm paymod.BodyMap) (aliRsp *FundTransCommonQueryResponse, err error) {
	var bs []byte
...
func (a *Client) FundAccountQuery(bm paymod.BodyMap) (aliRsp *FundAccountQueryResponse, err error) {
...
func (a *Client) TradeOrderinfoSync(body paymod.BodyMap) {

}

// alipay.system.oauth.token(换取授权访问令牌)
//    文档地址：https://opendocs.alipay.com/apis/api_9/alipay.system.oauth.token
func (a *Client) SystemOauthToken(bm paymod.BodyMap) (aliRsp *SystemOauthTokenResponse, err error) {
	if bm.Get("code") == paymod.NULL && bm.Get("refresh_token") == paymod.NULL {
...
func (a *Client) OpenAuthTokenApp(bm paymod.BodyMap) (aliRsp *OpenAuthTokenAppResponse, err error) {
	if bm.Get("code") == paymod.NULL && bm.Get("refresh_token") == paymod.NULL {
		return nil, errors.New("code and refresh_token are not allowed to be null at the same time")
	}
	err = bm.CheckEmptyError("grant_type")
...
func (a *Client) ZhimaCreditScoreGet(bm paymod.BodyMap) (aliRsp *ZhimaCreditScoreGetResponse, err error) {
	if bm.Get("product_code") == paymod.NULL {
...
func (a *Client) UserCertifyOpenInit(bm paymod.BodyMap) (aliRsp *UserCertifyOpenInitResponse, err error) {
...
func (a *Client) UserCertifyOpenCertify(bm paymod.BodyMap) (certifyUrl string, err error) {
...
func (a *Client) UserCertifyOpenQuery(bm paymod.BodyMap) (aliRsp *UserCertifyOpenQueryResponse, err error) {
	err = bm.CheckEmptyError("certify_id")
	if err != nil {
		return nil, err
	}
...
func (a *Client) UserInfoAuth(bm paymod.BodyMap) (aliRsp *UserInfoAuthResponse, err error) {
...
func (a *Client) DataBillBalanceQuery(bm paymod.BodyMap) (aliRsp *DataBillBalanceQueryResponse, err error) {
	var bs []byte
...
func (a *Client) DataBillDownloadUrlQuery(bm paymod.BodyMap) (aliRsp *DataBillDownloadUrlQueryResponse, err error) {
...
// 向支付宝发送请求
func (a *Client) doAliPay(bm paymod.BodyMap, method string) (bs []byte, err error) {
	var (
		bodyStr, url string
		bodyBs       []byte
	)
	...
	if a.LocationName != paymod.NULL && a.location != nil {
		a.mu.RLock()
		pubBody.Set("timestamp", time.Now().In(a.location).Format(paymod.TimeLayout))
		a.mu.RUnlock()
	} else {
		pubBody.Set("timestamp", time.Now().Format(paymod.TimeLayout))
	}
	pubBody.Set("version", "1.0")
	if a.NotifyUrl != paymod.NULL {
		a.mu.RLock()
		pubBody.Set("notify_url", a.NotifyUrl)
		a.mu.RUnlock()
	}
	if a.AppAuthToken != paymod.NULL {
		a.mu.RLock()
		pubBody.Set("app_auth_token", a.AppAuthToken)
		a.mu.RUnlock()
	}
	if a.AuthToken != paymod.NULL {
		a.mu.RLock()
		pubBody.Set("auth_token", a.AuthToken)
		a.mu.RUnlock()
	}
	if bodyStr != paymod.NULL {
	...
	default:
		...
		res, bs, errs := httpClient.Type(paymod.TypeForm).Post(url).SendString(param).EndBytes()
		if len(errs) > 0 {
			return nil, errs[0]
		}
