...
func (q *Client) PostRequest(bm paymod.BodyMap, url string, tlsConfig *tls.Config) (bs []byte, err error) {
...
func VerifySign(apiKey, signType string, bean interface{}) (ok bool, err error) {
	if apiKey == paymod.NULL || signType == paymod.NULL {
